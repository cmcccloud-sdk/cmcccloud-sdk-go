...
<h1 align="center">CMCC Cloud Go Software Development Kit (Go SDK)</h1>

The CMCC Cloud Go SDK allows you to easily work with CMCC Cloud services such as Elastic Compute Service (ECS) and
Virtual Private Cloud (VPC) without the need to handle API related tasks.

This document introduces how to obtain and use CMCC Cloud Go SDK.

## Requirements

- To use CMCC Cloud Go SDK, you must have CMCC Cloud account as well as the Access Key (AK) and Secret key (SK) of the CMCC
  Cloud account. You can create an AccessKey in the CMCC Cloud console.

- To use CMCC Cloud Go SDK to access the APIs of specific service, please make sure you do have activated the service
  in [CMCC Cloud console](https://console.joint.ecloud.10086.cn/) if needed.

- CMCC Cloud Go SDK requires go 1.14 or later, run command `go version` to check the version of Go.

## Install Go SDK

Run the following command to install CMCC Cloud Go SDK:

``` bash
# Install the library of CMCC Cloud Go SDK
go get github.com/cmcccloud-sdk/cmcccloud-sdk-go
```

## Code Example

- The following example shows how to query a list of VPCs in a specific region, you need to substitute your
  real `{service} "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/{service}/{version}"`
  for `vpc "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/vpc/v2"` in actual use, and initialize the client
...
import (
    "fmt"
    "github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/auth/basic"
    "github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/config"
    "github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/httphandler"
    vpc "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/vpc/v2"
    "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/vpc/v2/model"
    "net/http"
)
...
the [CHANGELOG.md](https://github.com/cmcccloud-sdk/cmcccloud-sdk-go/blob/master/CHANGELOG.md).

## User Manual [:top:](#cmcc-cloud-go-software-development-kit-go-sdk)
...
``` go
import "github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/config"
...
- `endpoint` varies with services and regions,
  see [Regions and Endpoints](https://ecloud.10086.cn/op-help-center/doc/article/38035) to obtain correct endpoint.
...
import (
	...
	service "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/service/v1"
	"github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/service/v1/model"
)
