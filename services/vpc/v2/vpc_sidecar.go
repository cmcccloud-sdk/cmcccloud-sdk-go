...
import "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/vpc/v2/model"
...
func (c *VpcClient) GetCreatePortRequest() *model.CreatePortRequest {
	return new(model.CreatePortRequest)
}
...
func (c *VpcClient) GetDeletePortRequest() *model.DeletePortRequest {
	return new(model.DeletePortRequest)
}
...
func (c *VpcClient) GetListPortsRequest() *model.ListPortsRequest {
	return new(model.ListPortsRequest)
}
...
func (c *VpcClient) GetShowPortRequest() *model.ShowPortRequest {
	return new(model.ShowPortRequest)
}
...
func (c *VpcClient) GetUpdatePortRequest() *model.UpdatePortRequest {
...
func (c *VpcClient) GetShowNetworkIpAvailabilitiesRequest() *model.ShowNetworkIpAvailabilitiesRequest {
	return new(model.ShowNetworkIpAvailabilitiesRequest)
}
