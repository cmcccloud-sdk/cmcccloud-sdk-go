...
import "github.com/cmcccloud-sdk/cmcccloud-sdk-go/services/cce/v3/model"

func (c *CceClient) GetAddNodeRequest() *model.AddNodeRequest {
	return new(model.AddNodeRequest)
}
...
func (c *CceClient) GetCreateKubernetesClusterCertRequest() *model.CreateKubernetesClusterCertRequest {
	return new(model.CreateKubernetesClusterCertRequest)
}
...
func (c *CceClient) GetMigrateNodeRequest() *model.MigrateNodeRequest {
	return new(model.MigrateNodeRequest)
}

func (c *CceClient) GetRemoveNodeRequest() *model.RemoveNodeRequest {
	return new(model.RemoveNodeRequest)
}

func (c *CceClient) GetResetNodeRequest() *model.ResetNodeRequest {
	return new(model.ResetNodeRequest)
}
