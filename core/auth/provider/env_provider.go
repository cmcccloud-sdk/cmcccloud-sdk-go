...
import (
	"github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/auth"
	"github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/auth/basic"
	"github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/auth/global"
	"github.com/cmcccloud-sdk/cmcccloud-sdk-go/core/sdkerr"
	"os"
	"strings"
)

const (
	akEnvName            = "CMCCCLOUD_SDK_AK"
	skEnvName            = "CMCCCLOUD_SDK_SK"
	projectIdEnvName     = "CMCCCLOUD_SDK_PROJECT_ID"
	domainIdEnvName      = "CMCCCLOUD_SDK_DOMAIN_ID"
	securityTokenEnvName = "CMCCCLOUD_SDK_SECURITY_TOKEN"
	idpIdEnvName         = "CMCCCLOUD_SDK_IDP_ID"
	idTokenFileEnvName   = "CMCCCLOUD_SDK_ID_TOKEN_FILE"
)
